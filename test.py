...
class TestHero(TestCase):
    ...
    def test_hero_enemy_same_names(self):
        ...
        self.assertEqual("You cannot fight yourself", str)
    ...
    def test_enemy_not_enough_health(self):
        ...
        with self.assertRaises(ValueError) as e:
            self.hero.battle(enemy)
        self.assertEqual("fYou cannot fight Enemy. He needs to rest", str(e.exception))
    ...
    def test_hero_loses(self):
        ...
        self.assertEqual(56.0, self.hero.health)
